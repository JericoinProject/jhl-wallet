...
from jhl_wallet.api import (
    WalletAPI,
)
from jhl_wallet.ui.page import (
    Page
)
...
class TransactionPage(Page):
    ...
    def __init__(self, *args, **kwargs):
        ...
        mb["menu"] = mb.menu
        mb.menu.add_radiobutton(label="JHL",
    ...
    def run(self):
        if self.token is None:
            ...
            tx_hash, tx_cost_eth = self.api.send_transaction(self.configuration,
                                                             ...
                                                             self.value,
                                                             self.token)
        messagebox.showinfo("Transaction validated!",
                            "Transaction was validated for " + str(tx_cost_eth) + "JHL fee.")
